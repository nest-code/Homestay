  ...
  <div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3">Homestay<sup></sup></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="?halaman=homestay"><i class="fas fa-fw fa-home"></i><span>Homestay</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="?halaman=peta"><i class="fas fa-fw fa-table"></i><span>Lokasi Homestay</span></a>
      </li>
